...
//   console.log("get");
//   try {
//     await db.query(`SELECT * FROM patient;`, (err, result) => {
//       if (err) throw err;
//       res.writeHead(200, {
...
export function post(req, res) {
  ...
  if (functionName === 'useTemplate') {
    ...
    db.query(`INSERT INTO use_template (template_id, patient_id, doctor_id, patient_name, patient_last_name, patient_gender, patient_option) VALUES (${templateInfo.template_id}, ${templateInfo.patient_id}, ${templateInfo.doctor_id}, '${templateInfo.patient_name}', '${templateInfo.patient_last_name}', '${templateInfo.patient_gender}', '${templateInfo.patient_option}')`, (err, result) => {
      if (err) throw err;
      res.writeHead(200, {
        'Content-Type': 'application/json'
      });
